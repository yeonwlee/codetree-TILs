...
for sick_info in sick_record:
    ...
    suspect_cheese.update([cheese for eater, cheese, eating_time in eating_cheese_record if eater == person and eating_time < sick_time])

for maybe_rot_cheese in suspect_cheese:
    max_num_of_sick_person = max(max_num_of_sick_person, sum(1 for _, cheese, _ in eating_cheese_record if cheese == maybe_rot_cheese))
