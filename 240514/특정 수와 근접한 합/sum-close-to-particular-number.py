...
for except_num1_index in range(num_of_numbers):
    ...
    for except_num2_index in range(except_num1_index + 1, num_of_numbers):
        difference_value_with_target_num = min(difference_value_with_target_num, sum_except_num1 - numbers[except_num2_index])

print(difference_value_with_target_num - target_num)